...
final class ModuleList[D <: DType](override val modules: TensorModule[D]*)
    ...
    // with TensorModule[D]:
    // TODO
    with TensorModule[D] with scala.collection.immutable.Iterable[TensorModule[D]]:
  ...
  /** Insert a given module before a given index in the list.
    ...
    * @return ModuleList[D] with new elements
    */
  ...
  /** Appends modules from a Python iterable to the end of the list.
    *
    * @param modules iterable of modules to append
    * @return
    */
